...
# Creates stage collections with initial example data
...
# Creates client account with initial example data
...
#Creates job collections with initial example data
...
# Creates applicant account with initial example data
# Password: M@ttC0rp
...
#Creates applications with initial example data 
...
# Creates a collection to store example CV data for applicants
...
# Initializes creation of the metaData collection
...
# Initializes the assessment collection
db.db.assessment.insert_one({})
# Creates questionStage collections with example question data
...
# Initialization of the feedback weights
