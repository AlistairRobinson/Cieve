...
db.db.stage.insert_one({"_id":ObjectId("5c7438edad9bb61ff6d81d39"),"type":"Test","description":"Tests the verbal reasoning of an applicant","title":"Verbal Test"})
...
db.db.vacancy.insert_one({"_id":ObjectId("5c8051911c9d4400004a696c"), "vacancy title": "Managing Director", "division": "Corporate & Investment Bank", "preferred degrees": ["University of Durham", "University of Southampton"], "role type": "Full-Time", "skills": {"Excel": "6", "Database Management": "5"}, "languages":{"Python":"9","Java":"7"}, "vacancy description": "We are looking for dedicated individuals with excellent analysis skills to join us full time as a Managing Director in Paris, France", "location": "Paris, France", "positions available": 15, "stages":["000000000000000000000000", "5c7438ecad9bb61ff6d81d38","5c74389bad9bb61fbcc01a3a","111111111111111111111111"], "start date": "ASAP", "min degree level":"2:1"})
...
db.db.metaData.insert_one({"divisions" : ["Corporate & Investment Bank", "Technology", "HR", "Finance"],"roles" : ["Internship", "Graduate", "Full-Time", "Part-Time"],"locations" : ["London, United Kingdom", "New York, United States", "Paris, France"]})
